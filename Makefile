...
pkgdatadir = $(datadir)/apertium-ton
pkgincludedir = $(includedir)/apertium-ton
pkglibdir = $(libdir)/apertium-ton
pkglibexecdir = $(libexecdir)/apertium-ton
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/apertium-ton.pc.in COPYING install-sh missing
...
CONFIG_CLEAN_FILES = apertium-ton.pc
...
am__installdirs = "$(DESTDIR)$(apertium_tondir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_ton_DATA) $(noinst_DATA) $(pkgconfig_DATA)
...
ACLOCAL = ${SHELL} /home/swatstudent/Source/ling073-ton/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/swatstudent/Source/ling073-ton/missing autoconf
AUTOHEADER = ${SHELL} /home/swatstudent/Source/ling073-ton/missing autoheader
AUTOMAKE = ${SHELL} /home/swatstudent/Source/ling073-ton/missing automake-1.14
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Tongan\" -DPACKAGE_TARNAME=\"apertium-ton\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Tongan\ 0.1.0\" -DPACKAGE_BUGREPORT=\"mcostag1@swarthmore.edu\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-ton\" -DPACKAGE=\"apertium-ton\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/swatstudent/Source/ling073-ton/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-ton
PACKAGE_BUGREPORT = mcostag1@swarthmore.edu
PACKAGE_NAME = Apertium Tongan
PACKAGE_STRING = Apertium Tongan 0.1.0
PACKAGE_TARNAME = apertium-ton
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-ton
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/swatstudent/Source/ling073-ton
abs_srcdir = /home/swatstudent/Source/ling073-ton
abs_top_builddir = /home/swatstudent/Source/ling073-ton
abs_top_srcdir = /home/swatstudent/Source/ling073-ton
am__leading_dot = .
...
install_sh = ${SHELL} /home/swatstudent/Source/ling073-ton/install-sh
...
###############################################################################
#
#   apertium_ton_dir: This is where the compiled binaries go
#   apertium_ton_srcdir: This is where the source files go
apertium_tondir = $(prefix)/share/apertium/$(BASENAME)/
apertium_ton_srcdir = $(prefix)/share/apertium/$(BASENAME)/
#EXTRA_TARGETS = $(LANG1).zhfst
EXTRA_TARGETS = 
apertium_ton_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS) $(LANG1).prob
...
$(am__aclocal_m4_deps):
apertium-ton.pc: $(top_builddir)/config.status $(srcdir)/apertium-ton.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_tonDATA: $(apertium_ton_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_ton_DATA)'; test -n "$(apertium_tondir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_tondir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_tondir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_tondir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_tondir)" || exit $$?; \
	done

uninstall-apertium_tonDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_ton_DATA)'; test -n "$(apertium_tondir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_tondir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_tondir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_tonDATA install-data-local \
...
uninstall-am: uninstall-apertium_tonDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_tonDATA install-data \
	...
	uninstall-am uninstall-apertium_tonDATA \
	uninstall-pkgconfigDATA
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_ton_srcdir) || mkdir -p $(DESTDIR)$(apertium_ton_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_ton_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_ton_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_ton_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_ton_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . ton-morph | tee .test-mt
